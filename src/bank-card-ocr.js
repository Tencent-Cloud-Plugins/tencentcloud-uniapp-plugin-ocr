...
/**
 * 卡证文字-银行卡识别 https://cloud.tencent.com/document/product/866/36216
...
export default function bankCardOCR({ imageBase64, imageUrl }) {
  return ocr.bankCardOCR({ imageBase64, imageUrl });
}

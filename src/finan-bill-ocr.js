...
/**
 * 票据单据-金融票据整单识别 https://cloud.tencent.com/document/product/866/38296
...
export default function finanBillOCR({ imageBase64, imageUrl }) {
  return ocr.finanBillOCR({ imageBase64, imageUrl });
}

...
/**
 * 卡证文字-营业执照识别 https://cloud.tencent.com/document/product/866/36215
...
export default function bizLicenseOCR({ imageBase64, imageUrl }) {
  return ocr.bizLicenseOCR({ imageBase64, imageUrl });
}

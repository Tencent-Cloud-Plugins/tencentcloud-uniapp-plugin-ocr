...
/**
 * 行业文档-算式识别 https://cloud.tencent.com/document/product/866/34939
...
export default function arithmeticOCR({ imageBase64, imageUrl }) {
  return ocr.arithmeticOCR({ imageBase64, imageUrl });
}

...
/**
 * 行业文档-数学公式识别 https://cloud.tencent.com/document/product/866/38293
...
export default function formulaOCR({ imageBase64, imageUrl }) {
  return ocr.formulaOCR({ imageBase64, imageUrl });
}

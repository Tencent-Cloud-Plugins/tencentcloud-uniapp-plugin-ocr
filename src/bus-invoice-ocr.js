...
/**
 * 票据单据-汽车票识别 https://cloud.tencent.com/document/product/866/37838
...
export default function busInvoiceOCR({ imageBase64, imageUrl }) {
  return ocr.busInvoiceOCR({ imageBase64, imageUrl });
}
